...
describe(Animal) do
  ...
  describe("#initialize") do
    it("lets you read the description out") do
      test_animal = Animal.new({:name => "Sparky", :date_in => "2017-05-02", :species => 'dog', :breed => 'dalmatian', :gender => 'male', :age => "3", :family_id => 1})
  ...
  describe("#==") do
    it("is the same task if it has the same description") do
      animal1 = Animal.new({:name => "Sparky", :date_in => "2017-05-02", :species => 'dog', :breed => 'dalmatian', :gender => 'male', :age => "3", :family_id => 1})
      animal2 = Animal.new({:name => "Sparky", :date_in => "2017-05-02", :species => 'dog', :breed => 'dalmatian', :gender => 'male', :age => "3", :family_id => 2})
